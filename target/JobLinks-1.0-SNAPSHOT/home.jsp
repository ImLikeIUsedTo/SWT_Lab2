...
<body>
    <div class="banner">
                    ...
                    <div class="hero-text">
                        ...
                        <div class="hero-actions">
                            <c:if test="${sessionScope.user.role == 'worker' || sessionScope.user.role == 'both'}">
                                ...
                                <a href="${pageContext.request.contextPath}/loadJobPoster" class="btn btn-primary btn-large">
        ...
        <!-- Phần Search and Filter trong home.jsp -->
            ...
            <form action="${pageContext.request.contextPath}/home" method="get" class="filter-form">
                ...
                <div class="form-group slider-container">
                    ...
                    <input type="range" id="budgetMax" name="budgetMax" min="10000.0" max="10000000.0" step="1000.0"
                           ...
                           oninput="updateBudgetRange()">
                    <span id="budgetRangeValue">Từ ${not empty param.budgetMin ? param.budgetMin : '10,000.0'} đến ${not empty param.budgetMax ? param.budgetMax : '50,000,000.0'} VND</span>
                </div>
                <div class="form-group">
        ...
        <script>
            function updateBudgetRange() {
                ...
                document.getElementById('budgetRangeValue').textContent = 
                    'Từ ' + Number(min).toLocaleString('vi-VN') + ' đến ' + Number(max).toLocaleString('vi-VN') + ' VND';
            }
            // Khởi tạo giá trị khi trang load
