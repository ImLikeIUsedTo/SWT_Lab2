    ...
    <div class="main-content">
        <div class="container">
            <div class="breadcrumb">
                ...
                <span>Công việc đã ẩn</span>
            </div>

            <div class="page-header">
                <div>
                    <h1 class="page-title">
                        <i class="fas fa-eye-slash"></i> Công việc đã ẩn
                    </h1>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <span>Danh sách Công việc Đã Ẩn</span>
                    <c:if test="${not empty tasks}">
                        <span style="margin-left: auto; background-color: var(--danger-color); color: white; padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-size: 0.8rem;">
                            ${fn:length(tasks)} công việc
                        </span>
                    </c:if>
                </div>
                <div class="card-body">
                    <c:choose>
                        <c:when test="${empty tasks}">
                            <div class="empty-state">
                                ...
                                <p>Bạn chưa ẩn công việc nào. Các công việc được ẩn sẽ xuất hiện tại đây và bạn có thể khôi phục hiển thị bất kỳ lúc nào.</p>
                            </div>
                        </c:when>
                        <c:otherwise>
                                ...
                                <div class="task-item" id="task-${task.taskId}">
                                    <div class="task-header">
                                        <div class="task-info">
                                            ...
                                            <div class="task-meta">
                                                ...
                                                <div class="meta-item">
                                                    ...
                                                    <span>
                                                        <c:choose>
                                                            <c:when test="${not empty task.scheduledTime}">
                                                                ${task.scheduledTime}
                                                            </c:when>
                                                            <c:otherwise>
                                                                Chưa xác định
                                                ...
                                                <div class="meta-item">
                                                    ...
                                                    <span>
                                                        <c:choose>
                                                            <c:when test="${not empty task.budget}">
                                                                ${task.budget} VND
                                                            </c:when>
                                                            <c:otherwise>
                                                                Chưa xác định
                                                ...
                                                <div class="meta-item">
                                                    ...
                                                    <span>
                                                        <c:choose>
                                                            <c:when test="${not empty task.createdTime}">
                                                                ${task.createdTime}
                                                            </c:when>
                                                            <c:otherwise>
                                                                Chưa xác định
                                                ...
                                                <span class="task-status status-hidden">
                                        ...
                                        <div class="task-actions">
                                            <a href="${pageContext.request.contextPath}/unhideTask?taskId=${task.taskId}" 
                                               class="btn btn-success"
                                               onclick="return confirm('Bạn có chắc chắn muốn hiển thị lại công việc này không?')">
                                                <i class="fas fa-eye"></i> Hủy Ẩn
                                            </a>
                                            ...
                                            <c:if test="${task.status != 'COMPLETED'}">
                                                <a href="${pageContext.request.contextPath}/editTask?taskId=${task.taskId}" 
            ...
            <a href="${pageContext.request.contextPath}/loadJobPoster" class="back-link">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (backLink) {
                backLink.addEventListener('click', function(e) {
                    // Allow normal navigation, just add smooth effect
