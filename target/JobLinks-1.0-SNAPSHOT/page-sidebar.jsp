...
<div class="sidebar" id="sidebar">
  ...
  <div class="sidebar-content">
    ...
    <div class="menu-item">
      ...
      <div class="submenu">
        <a href="${pageContext.request.contextPath}/tasks"><i class="fas fa-search"></i> Danh sách việc</a>
    ...
    <div class="menu-item">
      <a href="#" onclick="toggleSubmenu(event)"><i class="fas fa-amazon"></i> Report</a>
      <div class="submenu">
        <a href="reportUser.jsp"><i class="fas fa-search"></i> Report người dùng</a>
        <a href="reportUserList.jsp"><i class="fas fa-upload"></i> Report của tôi</a>
      </div>
    </div>
  </div>
