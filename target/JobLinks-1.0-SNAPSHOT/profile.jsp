...
<head>
    ...
    <style>
        ...
        .profile-info-item {
            ...
            margin-bottom: 20px;
            padding: 10px 0;
            border-bottom: 1px dashed #f5f5f5; /* Đường kẻ mờ */
        }
        .profile-info-item:last-child {
            border-bottom: none;
        }
        .profile-info-item i {
            color: #3498db; /* Màu xanh biểu tượng */
            font-size: 1.3rem;
            margin-right: 15px;
            width: 30px; /* Đảm bảo căn chỉnh */
            text-align: center;
        }
        .profile-info-item .label {
            font-weight: 600;
            color: #555;
            width: 150px; /* Căn chỉnh các label */
            flex-shrink: 0;
        }
    ...
    <div class="profile-card">
        ...
        <c:if test="${not empty user}">
            ...
            <div class="btn-group-custom">
                ...
                <a href="availableTasks.jsp" class="btn btn-outline-primary">
